$(function(){
	...
	var tweenTwo = TweenMax.fromTo(timeLine, 2,{height:"20%"}, {height:"40%"});
	...
	var tweenThree = TweenMax.fromTo(timeLine, 2,{height:"40%"}, {height:"60%"});
	...
	var tweenFour = TweenMax.fromTo(timeLine, 2,{height:"60%"}, {height:"80%"});

	var scene4 = new ScrollMagic.Scene({
	  triggerElement: '#post-4',
	}).setTween(tweenFour).addTo(controller);

	var tweenFive = TweenMax.fromTo(timeLine, 2,{height:"80%"}, {height:"150%"});
